...
from models.lama.saicinpainting.training.modules.ffc import FFCResNetGenerator
from models.lama.saicinpainting.training.modules.pix2pixhd import GlobalGenerator, MultiDilatedGlobalGenerator, \
